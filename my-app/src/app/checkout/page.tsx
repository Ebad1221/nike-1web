    ...
    <div className='grid grid-cols-12 px-10 my-10 lg:px-32 lg:gap-20'>
        <div className='col-span-12 lg:col-span-8'>
            ...
            <div className='flex border-[1.5px] border-black px-4 py-4  rounded-lg my-10'>
                <Image src={"/Frame (21).png"} alt='Deliver Icon' width={24} height={24}/>
        ...
        <div className='col-span-12 lg:col-span-4 mt-10 lg:mt-0'>
            ...
            <div>
                <Image src={"/Frame (22).png"} alt="Nike Dri-FIT ADV TechKnit Ultra "width={204} height={204}
            ...
            <div>
                <Image src={"/Frame (23).png"} alt="Nike Dri-FIT ADV TechKnit Ultra"width={208} height={208}
                    className="mt-4 object-cover rounded-md"/>
                <div>
                <h3 className="text-lg font-medium mt-2">
                    Nike Dri-FIT ADV TechKnit Ultra
